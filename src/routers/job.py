...
from database import crud, schema, database, models  # Grouped and organized imports
...
def read_jobs(skip: int = 0, limit: int = 10, organization_id: Optional[int] = None, db: Session = Depends(database.get_db)) -> List[models.Job]:
